...
export const COMMAND_FLAGS: Record<string, readonly string[]> = {
  ...
  jobs: ["watch"],
  staff: ["reason", "name", "quota", "json", "source", "state", "kind", "limit", "include", "exclude", "status", "markdown", "selector", "executor", "rate-delay", "sitemap", "yes", "watch", "failed", "urgent", "rolling", "fixed", "npm", "pypi", "github", "tag-pattern", "staff", "product"],
};
