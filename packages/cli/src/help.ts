...
export const HELP = `grimoire ${VERSION} — documentation retrieval for AI agents
  ...
  grimoire staff source <product|id> [--include <pattern>]... [--exclude <pattern>]... [--status active|disabled] [--markdown on|off] [--selector <css>|none] [--executor worker|queue] [--rate-delay <seconds>]
